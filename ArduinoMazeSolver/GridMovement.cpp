...
// Kalibriert die Sensoren indem nach Links und Rechts beweget wird
...
// Folgt einem Linien Segment bis dieser unterbrochen wird
void followSegment()
{
  while(1)
  {
    // Position der Linie herausfinden
    uint16_t position = readSensors();

    // Der Error symbolosiert, wie weit entfernt man von der Linie ist
...
// Führt den Roboter zum Center eine Kreuzung
